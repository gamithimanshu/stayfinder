      ...
      <PageSection>
        <PageShell>
          <SurfaceCard className="space-y-4 p-10 text-center">
            ...
            <div><Link to="/listings" className="btn-secondary">Back to listings</Link></div>
          </SurfaceCard>
        </PageShell>
      </PageSection>
    );
            ...
            <div className="mt-6 space-y-5">
              ...
              {selectedMethod === "upi" ? (
                <FormField label="UPI ID" hint="Example: name@upi">
                  <TextInput name="upiId" value={payerDetails.upiId} onChange={handleInput} placeholder="Enter UPI ID" />
                </FormField>
              ) : null}
              ...
              {selectedMethod === "card" ? (
                <>
                  <FormField label="Card Holder Name">
                    <TextInput name="cardHolder" value={payerDetails.cardHolder} onChange={handleInput} placeholder="Enter card holder name" />
                  </FormField>
                  <FormField label="Card Number">
                    <TextInput name="cardNumber" value={payerDetails.cardNumber} onChange={handleInput} placeholder="4111 1111 1111 1111" />
                  </FormField>
